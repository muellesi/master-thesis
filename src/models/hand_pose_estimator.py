...
def train_model(model, train_gen, batch_size, max_epochs, validation_gen=None):
    ...
    tensorboard = keras.callbacks.TensorBoard(log_dir="./data/tensorboard_logs", histogram_freq=0,
